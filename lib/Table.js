...
export default class Table extends Events {
    ...
    async find(func, context = {}) {
        ...
        let stream = this.#threadPool.executeQuery(func, context, this.#meta, this.#path, this.#dbname, this.#cache)
        let result = null;
    ...
    filter(func, context = {}) {
        //let before = await this.emitBefore("query", {func, context})
        let result = this.#threadPool.executeQuery(func, context, this.#meta, this.#path, this.#dbname, this.#cache)
